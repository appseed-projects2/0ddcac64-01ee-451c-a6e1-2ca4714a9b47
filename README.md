...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-14 06:24`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0ddcac64-01ee-451c-a6e1-2ca4714a9b47.git
$ cd 0ddcac64-01ee-451c-a6e1-2ca4714a9b47
```
